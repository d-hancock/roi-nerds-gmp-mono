...
export const PageHero = ({
  ...
  return (
    <div tw="relative bg-gray-50 overflow-hidden">
      ...
      <div tw="relative pb-16 sm:pb-24">
        <main tw="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
          <div tw="text-center">
            <Title
              beginingTitle={beginingTitle}
...
function CtaSection({ ctaPrimary, ctaSecondary }) {
  return (
...
function Title({ beginingTitle, highlightTitle }) {
  return (
